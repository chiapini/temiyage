...
<br>・　まとめサイトには話題の商品しか掲載されておらず、企業HPでは自社商品の情報しか得られない
<br>・　通販サイト（楽天・Amazonなど）での商品比較は可能だが、配送前提のため店頭商品が網羅されていない
<br>この経験から、消費者が複数企業の商品を一つのプラットフォームで比較できるサービスの必要性を強く感じた。

2.　 企業側の課題<br>
私の勤務先の洋菓子店では、新商品を百貨店のInstagramで告知していたが、百貨店のSNSでは食品以外の情報も多く、PRが埋もれやすい状況だった。
...
# 実装予定の機能	
1. 検索機能の充実化<br>
現状でもある程度の検索は可能だが、「のしの有無」「プレゼント包装の可否」などの細かい条件での検索も可能にしたい。
2. ランキングの表示<br>
投稿数が増えると一覧ページが見づらくなる課題がある。口コミ数やいいね数を基準にしたランキング機能を提供し、人気商品を直感的に把握できるようにしたい。
...
# 工夫したポイント
1.　 会員登録時のアンケートとグラフ化
<br>・ユーザー情報をアンケートで収集し、グラフとして提供
<br>・企業側はユーザーの背景や嗜好を把握でき、よりニーズに沿ったコンテンツ制作が可能に
<br>2. 　 手土産選びの豆知識をスライド形式で提供
<br>・情報収集に苦戦する消費者のため、1つのサイトで情報収集が完結するよう工夫
<br>・手土産選びに役立つ豆知識を視覚的に分かりやすく提示
<br>3. 　 ビューの色合いの工夫
<br>・お菓子＝可愛い印象だが、男性ユーザーのビジネス利用も考慮
<br>・画面を長時間見ても疲れにくいよう、薄い暖色系で統一
<br>4. 　 投稿権限を企業側のみに限定
<br>・当初は一般ユーザー投稿も検討したが、品質維持のため企業のみに限定
<br>・ユーザー参加型要素は口コミ機能や地域情報発信で補完し、サービスの面白みを確保
