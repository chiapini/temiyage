ActiveAdmin.register User do
  ...
  #
  permit_params :email, :encrypted_password, :nickname, :gender, :situation, :children, :age_id, :job_id, :area_id, :think_id, :admin, :reset_password_token, :reset_password_sent_at, :remember_created_at
  #
  # or
  #
  # permit_params do
