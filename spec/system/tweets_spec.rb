...
RSpec.describe 'ツイート投稿', type: :system do
  ...
  context 'ツイート投稿ができるとき'do
    it 'ログインしたユーザーは新規投稿できる' do
      ...
      select '洋菓子', from: 'tweet[category_id]'
      fill_in 'tweet_shop_name', with: @tshop_name
      fill_in 'tweet_item_name', with: @item_name
      fill_in 'tweet_information', with: @information
      fill_in 'tweet_area', with: @area
      fill_in 'tweet_capacity', with: @tweet_capacity
      fill_in 'tweet_expiry', with: @tweet_expiry
      fill_in 'tweet_quantity', with: @tweet_quantity
      fill_in 'tweet_price', with: @tweet_price
      fill_in 'tweet_keep', with: @tweet_keep
      fill_in 'tweet_allergy', with: @tweet_allergy
      fill_in 'tweet_url', with: @tweet_url
      ...
      expect(page).to have_selector ".tweet_image: url(#{@tweet_image});']"
